...
# Hugo Sant'Anna
# November 2023
# Description: Are there any effects related to occupations?
...
esmodel_immiocc <- vz_es_model(dt)
...
# Generate the tables
tabprinter(dt, twfemodel_immiocc, outcome = "immiocc")
...
eventstudy(esmodel_immiocc, outcome = "immiocc")
